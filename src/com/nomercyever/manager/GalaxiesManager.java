...
public class GalaxiesManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        backupOracleButton = new javax.swing.JButton();
        restoreOracleButton = new javax.swing.JButton();
        ...
        backupOracleButton.setText("Backup");
        backupOracleButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                backupOracleButtonActionPerformed(evt);
            }
        });

        restoreOracleButton.setText("Restore");
        restoreOracleButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                restoreOracleButtonActionPerformed(evt);
            }
        });
        ...
        oracleWindowLayout.setHorizontalGroup(
            ...
            .addGroup(oracleWindowLayout.createSequentialGroup()
                ...
                .addGroup(oracleWindowLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(launchSQLdButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE)
                    ...
                    .addComponent(backupOracleButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(restoreOracleButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, oracleWindowLayout.createSequentialGroup()
                .addGroup(oracleWindowLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(oracleWindowLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(backupOracleButton, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(restoreOracleButton, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        toolsWindowLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, toolsWindowLayout.createSequentialGroup()
                ...
                .addGroup(toolsWindowLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(closeToolsButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(updateServerButton, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(18, 18, 18)
        ...
        toolsWindowLayout.setVerticalGroup(
            ...
            .addGroup(toolsWindowLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addGroup(toolsWindowLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void StartLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartLoginActionPerformed
        try {
            ...
            String[] commands = {"bash","/home/swg/swg-main/gm/scripts/./nohupLogin.sh"};
...
jTextArea1.read(new FileReader("/home/swg/swg-main/gm/logs/startLogin.txt"), "blah");
String s = null;
String line = "";
String output = "";
...
while ((s = stdError.readLine()) != null) {
    ...
    private void StartChatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartChatActionPerformed
        ...
        try {
            // TODO add your handling code here:
            Runtime rt = Runtime.getRuntime();
            String[] commands = {"bash","/home/swg/swg-main/gm/scripts/./nohupChat.sh"};
            Process proc = rt.exec(commands);
...
jTextArea2.read(new FileReader("/home/swg/swg-main/gm/logs/startChat.txt"), "blah");
String s = null;
String line = "";
String output = "";
while ((s = stdInput.readLine()) != null) {
...
while ((s = stdError.readLine()) != null) {
    ...
    private void StartGameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartGameActionPerformed
        ...
        try {
            // TODO add your handling code here:
            Runtime rt = Runtime.getRuntime();
            String[] commands = {"bash","/home/swg/swg-main/gm/scripts/./nohupStart.sh"};
            Process proc = rt.exec(commands);
...
jTextArea3.read(new FileReader("/home/swg/swg-main/gm/logs/startServer.txt"), "blah");
String s = null;
String line = "";
String output = "";
while ((s = stdInput.readLine()) != null) {
...
while ((s = stdError.readLine()) != null) {
    ...
    private void OracleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OracleButtonActionPerformed
        ...
        try {
            // TODO add your handling code here:
            Runtime rt = Runtime.getRuntime();
            String[] commands = {"bash","/home/swg/swg-main/gm/scripts/./oracleStatus.sh"};
            Process proc = rt.exec(commands);
...
OracleStatus.read(new FileReader("/home/swg/swg-main/gm/logs/oracleStatus.txt"), "blah");
String s = null;
String line = "";
String output = "";
while ((s = stdInput.readLine()) != null) {
...
while ((s = stdError.readLine()) != null) {
    ...
    private void KillGameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KillGameActionPerformed
        // TODO add your handling code here:
            ...
            // TODO add your handling code here:
            Runtime rt = Runtime.getRuntime();
            String[] commands = {"bash","/home/swg/swg-main/gm/scripts/./killGame.sh", "&"};
            Process proc = rt.exec(commands);
...
while ((s = stdError.readLine()) != null) {
    ...
    private void KillAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KillAllActionPerformed
        ...
        try {
            // TODO add your handling code here:
            Runtime rt = Runtime.getRuntime();
            String[] commands = {"bash","/home/swg/swg-main/gm/scripts/./killServers.sh", "&"};
            Process proc = rt.exec(commands);
...
while ((s = stdError.readLine()) != null) {
    ...
    private void clearLogsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearLogsActionPerformed
        try {
            // TODO add your handling code here:
            Runtime rt = Runtime.getRuntime();
            String[] commands = {"bash","/home/swg/swg-main/gm/scripts/./clearLogs.sh", "&"};
            Process proc = rt.exec(commands);
        } catch (IOException ex) {
            Logger.getLogger(GalaxiesManager.class.getName()).log(Level.SEVERE, null, ex);
        }
...
while ((s = stdError.readLine()) != null) {
    ...
    private void backupOracleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backupOracleButtonActionPerformed
        // TODO add your handling code here:
       new BackupManager().setVisible(true);
    }//GEN-LAST:event_backupOracleButtonActionPerformed
    ...
    private void restoreOracleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restoreOracleButtonActionPerformed
        // TODO add your handling code here:
        File workingDirectory = new File(System.getProperty("user.dir")+ System.getProperty("file.separator")+ "backups" + System.getProperty("file.separator")+ "images");
        oracleWindow.setVisible(false);
    ...
    }//GEN-LAST:event_restoreOracleButtonActionPerformed
    ...
    private javax.swing.JButton backupOracleButton;
    ...
    private javax.swing.JButton restoreOracleButton;
